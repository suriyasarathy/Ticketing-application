...
CREATE TABLE `user_teams` (
  ...
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`),
  KEY `fk_user_teams_team` (`team_id`),
  CONSTRAINT `fk_user_teams_team` FOREIGN KEY (`team_id`) REFERENCES `teams` (`team_id`) ON DELETE CASCADE,
  CONSTRAINT `user_teams_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`) ON DELETE CASCADE
...
INSERT INTO `user_teams` VALUES (62,45,39),(63,44,39),(64,42,39),(65,28,39);
