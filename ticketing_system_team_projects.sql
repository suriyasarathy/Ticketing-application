...
CREATE TABLE `team_projects` (
  ...
  PRIMARY KEY (`id`),
  KEY `team_id` (`team_id`),
  KEY `team_projects_ibfk_2` (`project_id`),
  CONSTRAINT `team_projects_ibfk_1` FOREIGN KEY (`team_id`) REFERENCES `teams` (`team_id`) ON DELETE CASCADE,
  CONSTRAINT `team_projects_ibfk_2` FOREIGN KEY (`project_id`) REFERENCES `projects` (`project_id`) ON DELETE CASCADE
...
INSERT INTO `team_projects` VALUES (100,39,4242025120921),(101,39,5062025143345),(102,39,4292025182031),(103,39,6032025144815);
