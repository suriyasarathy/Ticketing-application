...
CREATE TABLE `teams` (
  ...
  PRIMARY KEY (`team_id`),
  KEY `teams_ibfk_1` (`team_lead_id`),
  CONSTRAINT `teams_ibfk_1` FOREIGN KEY (`team_lead_id`) REFERENCES `user` (`user_id`) ON DELETE CASCADE
...
INSERT INTO `teams` VALUES (39,'Developer',41);
